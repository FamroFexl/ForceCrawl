...
public class ConfigScreen extends Screen {
	...
	public void render(PoseStack poseStack, int i, int j, float f) {
		...
		GuiComponent.drawString(poseStack, this.font, FormattedCharSequence.forward(MutableComponent.create((ComponentContents) new TranslatableContents("config.forcecrawl.crawlMode", "config.forcecrawl.crawlMode", null)).getString(), Style.EMPTY.withColor(ChatFormatting.GRAY)), this.width / 2 - 180, 50, 0xFFFFFF);
		//Render widgets
